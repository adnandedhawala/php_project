			...
			<div class="row">
				<div class="col">
					<div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
						...
						<!-- Product 3 -->
<?php  
	$pro_str="select pro_id,pro_name,pro_price,pro_discount,pro_description,pro_caid,pro_path,ca_name,ca_id from category,products where pro_caid=ca_id order by pro_id ";
