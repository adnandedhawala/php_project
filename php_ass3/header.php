...
?>
  ...
  <a href="logout.php"> <?php echo $_SESSION['useremail'];?>  Logout </a>
<?php
	endif;
?>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
					...
					if(isset($_SESSION['useremail'])):
					?>
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">User panel<b class="caret"></b></a>
						<ul class="dropdown-menu" role="menu">

						<li><a href="add_area.php">Add area</a></li>
						<li><a href="add_cinema.php">Add cinema hall</a></li>
						<li><a href="add_screen.php">Add Screen</a></li>
						<li><a href="add_time.php">Add Time</a></li>	
						<li><a href="add_seats.php">Add Seat</a></li>		
						<li><a href="add_movie.php">Add Movie</a></li>		
						<li><a href="assign_movie.php">Assign Movie</a></li>		
