			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form  id="login_form">
							<input type="text" placeholder="admin@gmail.com" name="log_email" />
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form id="register_form">
							<input type="text" placeholder="Akshay" name="log_name" />
							<input type="text" placeholder="9860098600" name="log_mobile" />
							<input type="text" placeholder="akshay@gmail.com" name="log_email" />
							<input type="password" placeholder="Your Password" name="log_password" />
