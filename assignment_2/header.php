...
<div class="login_page">
  ...
  <div class="user_register">
    ...
    <form>
      <!-- <label for="ho"></label> -->
      <input type="text" name="ho" value="hell">
      <!-- <label></label> -->
  ...
  <div class="user_login">
    ...
    <form>
      <!-- <label></label> -->
      <input type="text" name="" value="hell">
      <input type="text" name="">
      <input type="text" name="">
    </form>
  </div>
  ...
  <div class="tail-bottom">
    <div id="main">
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            <li class="home_button active oone" for="home"><a href="#">Home</a></li>
      ...
      <!--   <div id="slogan">
        ...
        <div class="box box_display" style="margin-top: 2%">
